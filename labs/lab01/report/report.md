...
Перед началом работы с Vagrant создадим каталог для проекта. В ОС Windows C:\work\arromicihna\packer и C:\work\arromicihna\vagrant (рис. [-@fig:001]).
...
Перейдем к пользователю arromicihna (рис. [-@fig:010]): su – arromicihna

![Переход к пользователю arromicihna.](image/10.png){#fig:010 width=70%}
