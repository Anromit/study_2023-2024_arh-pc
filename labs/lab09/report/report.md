...
Создаем каталог для программ Лабораторных работ, и в нем создаем файл (рис. @fig:001).

![Создаем каталог с помощью команды mkdir и файл с помощью команды touch](image/1.png){#fig:001 width=70%}

Открываем файл с помощью gedit и заполняем его в соответствии с листингом 9.1 (рис. @fig:002).
...
Открываем файл для редактирования и изменяем его, добавив подпрограмму в подпрограмму (рис. @fig:004).
...
Переключаемся на отображение команд с Intel синтаксисом (рис. @fig:012).
...
Копируем файл lab8-4.asm(ср №1 в лабораторной работый 8) в файл с именем lab09-3.asm (рис. @fig:028).

![Копируем файл](image/28.png){#fig:028 width=70%}

Открываем файл с gedit и меняем его, создавая подпрограмму (рис. @fig:029).
...
Открываем файл с помощью gedit и заполняем его в соответствии с листингом 9.3 (рис. @fig:032).
